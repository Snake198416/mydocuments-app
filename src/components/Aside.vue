<template>
    <aside id="aside" class="ui-aside">
        <ul class="nav" ui-nav>
            ...
            <li>
                <router-link to="/invoices">Счета</router-link>
            </li>
            <li>
                <router-link to="/acts">Акты</router-link>
            </li>
            ...
            <!--не нужно-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-bar-chart-o"></i><span>Charts</span><i-->
...
<!--            </li>-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-snowflake-o"></i><span>UI Elements</span><i-->
<!--                        class="fa fa-angle-right pull-right"></i></a>-->
<!--                <ul class="nav nav-sub">-->
...
<!--            </li>-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-bookmark-o"></i><span>Components <small class="label label-danger">3</small> </span>-->
...
<!--            </li>-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-table"></i><span>Data Tables</span><i-->
<!--                        class="fa fa-angle-right pull-right"></i></a>-->
<!--                <ul class="nav nav-sub">-->
...
<!--            </li>-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-list-alt"></i><span>Form</span><i-->
<!--                        class="fa fa-angle-right pull-right"></i></a>-->
<!--                <ul class="nav nav-sub">-->
...
<!--            </li>-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-television"></i><span>Extra Pages</span><i-->
<!--                        class="fa fa-angle-right pull-right"></i></a>-->
<!--                <ul class="nav nav-sub">-->
...
<!--            </li>-->
<!--            <li>-->
<!--                <a href=""><i class="fa fa-server"></i><span>Multilevel</span><i-->
<!--                        class="fa fa-angle-right pull-right"></i></a>-->
<!--                <ul class="nav nav-sub">-->
<!--                    <li class="nav-sub-header"><a href="#"><span>Multilevel</span></a></li>-->
<!--                    <li><a href="#"><span>Level One </span></a></li>-->
<!--                    <li>-->
<!--                        &lt;!&ndash; <a href=""><span>Level Two </span></a> &ndash;&gt;-->
